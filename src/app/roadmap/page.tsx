...
const programTypes = [
  {
    ...
    description: 'Đây là hình thức phổ biến nhất với thời hạn 3-5 năm, dành cho bất kỳ ai có thể làm việc <i><b>lao động phổ thông</b></i>, tuổi từ 18-40 không yêu cầu bằng cấp, không cần thi tuyển tay nghề và có thể nâng cấp lên visa Kỹ năng đặc định sau khi hoàn thành.',
    color: 'orange'
  },
  {
    icon: UserCheck,
    title: 'Kỹ năng đặc định (Tokutei)',
    description: 'Dành cho lao động có tay nghề, cho phép làm việc lâu hơn tại Nhật và hưởng lương cao hơn. Người đi mới hoặc chuyển trái ngành cần thi chứng chỉ tiếng Nhật và kỳ thi kỹ năng tay nghề, sau giai đoạn 1 có thể nâng cấp lên giai đoạn 2 để định cư tại Nhật.',
     color: 'dark-blue'
  },
  {
    icon: Briefcase,
