...
const steps = [
  { text: 'Tìm hiểu các đơn hàng', icon: Search },
  { text: 'Đăng ký ứng tuyển', icon: FileSignature },
  { text: 'Đào tạo phỏng vấn', icon: Mic },
  { text: 'Phỏng vấn đơn hàng', icon: Users },
  { text: 'Đào tạo sau trúng tuyển', icon: School },
  { text: 'Xử lý hồ sơ xin visa', icon: FileText },
  { text: 'Vào công ty làm việc', icon: Building },
  { text: 'Đào tạo & Thăng tiến', icon: TrendingUp },
];
