...
export const industriesByJobType: { [key: string]: Industry[] } = {
    ...
    'Kỹ năng đặc định': [
      ...
      { name: 'Vận tải', slug: 'van-tai-tokutei', keywords: ['vận tải', 'logistics', 'bốc dỡ', 'lái xe', 'Hậu cần vận tải', 'Lái xe buýt cỡ lớn', 'Lái xe buýt cỡ trung', 'Lái xe tải cỡ lớn', 'Lái xe tải cỡ nhỏ', 'Lái xe tải cỡ trung', 'Lái xe taxi', 'Phụ xe', 'Quản lý kho vận tải', 'Thực tập lái xe'] },
