...
export const industriesByJobType: { [key: string]: Industry[] } = {
    ...
    'Kỹ năng đặc định': [
      ...
      { name: 'Lưu trú, khách sạn', slug: 'luu-tru-khach-san-tokutei', keywords: ['lưu trú', 'khách sạn', 'lễ tân', 'phục vụ', 'tiếp khách', 'quản lý vệ sinh', 'hành lý khách sạn', 'quản lý khách sạn'] },
    ...
    'Kỹ sư, tri thức': [
        ...
        { name: 'Sản xuất, chế tạo, công nghệ', slug: 'san-xuat-che-tao-cong-nghe-ks', keywords: [] },
        { name: 'Cơ khí, máy móc', slug: 'co-khi-may-moc-ks', keywords: [] },
        { name: 'Công nghệ ô tô', slug: 'cong-nghe-o-to-ks', keywords: [] },
        { name: 'Vận chuyển hàng hoá', slug: 'van-chuyen-hang-hoa-ks', keywords: [] },
        ...
        { name: 'Tài chính, kế toán, bảo hiểm', slug: 'tai-chinh-ke-toan-bao-hiem-ks', keywords: [] },
        { name: 'Báo chí, truyền thông, marketing', slug: 'bao-chi-truyen-thong-marketing-ks', keywords: [] },
        { name: 'Công nghệ thông tin', slug: 'cong-nghe-thong-tin-ks', keywords: [] },
        ...
        { name: 'Nghệ thuật, nghệ sĩ', slug: 'nghe-thuat-nghe-si-ks', keywords: [] },
        { name: 'Thể dục thể thao', slug: 'the-duc-the-thao-ks', keywords: [] },
        { name: 'Nghề có kỹ năng chuyên nghiệp', slug: 'nghe-co-ky-nang-chuyen-nghiep-ks', keywords: [] },
