...
export const industriesByJobType: { [key: string]: Industry[] } = {
    ...
    'Kỹ sư, tri thức': [
      ...
      { name: 'Kinh doanh, kinh tế', slug: 'kinh-doanh-kinh-te-ks', keywords: ['kinh doanh', 'kinh tế', 'Bán hàng miễn thuế', 'Dịch vụ bán hàng', 'Dịch vụ khách hàng tổng hợp', 'Dịch vụ nhà hàng', 'Điều hành', 'Hoạt động khởi nghiệp', 'Kinh doanh kế toán', 'Nghiên cứu thị trường, marketing', 'Nhân viên dịch vụ khác (không phân loại nơi khác)', 'Quản lý', 'Quản lý kế hoạch quảng cáo, truyền thông', 'Thương mại nước ngoài', 'Tiếp thị (sales) doanh nghiệp'] },
