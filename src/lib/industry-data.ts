...
export const industriesByJobType: { [key: string]: Industry[] } = {
    ...
    'Kỹ sư, tri thức': [
      ...
      { name: 'Kinh doanh, kinh tế', slug: 'kinh-doanh-kinh-te-ks', keywords: ['kinh doanh', 'kinh tế', 'Bán hàng miễn thuế', 'Dịch vụ bán hàng', 'Dịch vụ khách hàng tổng hợp', 'Điều hành', 'Hoạt động khởi nghiệp', 'Kinh doanh kế toán', 'Nghiên cứu thị trường, marketing', 'Nhân viên dịch vụ khác (không phân loại nơi khác)', 'Quản lý', 'Quản lý kế hoạch quảng cáo, truyền thông', 'Thương mại nước ngoài', 'Tiếp thị (sales) doanh nghiệp'] },
      { name: 'Tài chính, kế toán, bảo hiểm', slug: 'tai-chinh-ke-toan-ks', keywords: ['tài chính', 'kế toán', 'bảo hiểm', 'Kế toán công chứng', 'Kế toán công chứng nước ngoài', 'Kế toán thuế', 'Tư vấn bảo hiểm xã hội'] },
      { name: 'Báo chí, truyền thông, marketing', slug: 'bao-chi-marketing-ks', keywords: ['báo chí', 'truyền thông', 'marketing', 'Biên tập', 'Digital Marketing', 'Nhà báo', 'Thiết kế Marketing', 'Viết quảng cáo'] },
      { name: 'Công nghệ thông tin', slug: 'it-ks', keywords: ['công nghệ thông tin', 'IT', 'lập trình', 'phần mềm', 'Blockchain', 'BrSE (Bridge System Engineer)', 'Business Analyst (BA)', 'COO (Chief Operation Officer)', 'CTO (Chief Technology Officer)', 'ITM (Information Technical Manager)', 'Lập trình nhúng', 'Lập trình viên', 'PM (Product Manager)', 'PO (Product Owner)', 'Tester', 'Thiết kế', 'Thiết kế UI, UX', 'Trí tuệ nhân tạo', 'Vận hành web thương mại điện tử'] },
      { name: 'Nghiên cứu, phân tích', slug: 'nghien-cuu-phan-tich-ks', keywords: ['nghiên cứu', 'phân tích', 'Khảo sát đất đai, nhà ở', 'Nghiên cứu', 'Nghiên cứu thị trường'] },
      { name: 'Giáo dục, đào tạo', slug: 'giao-duc-dao-tao-ks', keywords: ['giáo dục', 'đào tạo', 'Giảng dạy có chứng chỉ', 'Giảng dạy đại học', 'Giảng dạy ngoài cơ sở giáo dục', 'Giảng dạy ngôn ngữ tại Tiểu học, THCS, PTTH', 'Giảng dạy trường dạy nghề (Senmon)', 'Giảng dạy trường học các loại', 'Giảng dạy trường quốc tế', 'Hướng dẫn nghiên cứu', 'Hướng dẫn thể thao'] },
      { name: 'Hành chính, văn phòng', slug: 'hanh-chinh-van-phong-ks', keywords: ['hành chính', 'văn phòng', 'Biên dịch, phiên dịch', 'Nhân viên văn phòng'] },
