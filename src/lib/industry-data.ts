...
export const industriesByJobType: { [key: string]: Industry[] } = {
    ...
    'Kỹ năng đặc định': [
      ...
      { name: 'Chế tạo Vật liệu', slug: 'che-tao-vat-lieu-tokutei', keywords: ['chế tạo', 'vật liệu', 'đúc', 'rèn', 'sơn', 'Đúc khuôn', 'Hoàn thiện khuôn', 'Hoàn thiện sản phẩm ép đùn', 'Hoàn thiện dụng cụ nung chảy', 'Đúc gang', 'Đúc kim loại màu', 'Đúc khuôn buồng lạnh', 'Đúc khuôn buồng nóng', 'Rèn bằng búa', 'Xử lý nhiệt bề mặt', 'Xử lý nhiệt một phần', 'Xử lý nhiệt tổng thể'] },
